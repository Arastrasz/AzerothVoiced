-- AzerothVoiced/Modules/QuotePacksUI.lua
...
-- HOW TO DISABLE: Remove this file, packs still work via /avpacks

local MODULE_VERSION = "1.0.0"

-- Check if QuotePacks module is loaded
if not AzerothVoiced_QuotePacks then
...
-- Main Browser Frame
------------------------------------------------------------
local Browser = CreateFrame("Frame", "AzerothVoicedPacksBrowser", UIParent, BackdropTemplateMixin and "BackdropTemplate")
...
for i, f in ipairs(filters) do
  ...
  btn:SetScript("OnClick", function()
    currentFilter = f
    UpdateFilters()
    AzerothVoiced_RefreshPacksList()
  end)
...
local function CreatePackCard(parent, pack, yOffset)
  ...
  local installed = AzerothVoiced_IsPackInstalled(pack.id)
  ...
  if installed then
    ...
    actionBtn:SetScript("OnClick", function()
      local ok, r = AzerothVoiced_UninstallPack(pack.id)
      print((ok and "|cff00ff00" or "|cffff0000") .. "Azeroth Voiced: " .. r .. "|r")
      AzerothVoiced_RefreshPacksList()
    end)
    ...
    actionBtn:SetScript("OnClick", function()
      local ok, r = AzerothVoiced_InstallPack(pack.id)
      print((ok and "|cff00ff00" or "|cffff0000") .. "Azeroth Voiced: " .. r .. "|r")
      AzerothVoiced_RefreshPacksList()
    end)
...
-- Refresh Packs List
------------------------------------------------------------
function AzerothVoiced_RefreshPacksList()
  ...
  local packs = AzerothVoiced_GetAvailablePacks()
  local y = 5
  local visible = 0
  ...
  for _, pack in ipairs(packs) do
    ...
    elseif currentFilter == "installed" then show = AzerothVoiced_IsPackInstalled(pack.id)
...
-- Public API
------------------------------------------------------------
function AzerothVoiced_OpenPacksBrowser()
  AzerothVoiced_RefreshPacksList()
  Browser:Show()
end

Browser:SetScript("OnShow", AzerothVoiced_RefreshPacksList)
tinsert(UISpecialFrames, "AzerothVoicedPacksBrowser")

print("|cffffaa00Azeroth Voiced QuotePacksUI loaded|r - Browser ready")
